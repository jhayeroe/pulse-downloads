...
function signOut(){saveSession(null);context=null;assignments=[];if(timer)clearInterval(timer);$('appView').classList.add('hidden');$('loginView').classList.remove('hidden');$('password').value=''}
