...
$('doneBtn').onclick=doneOccurrence;
$('accomplishBtn').onclick=accomplish;
...
loadSession();loadLocal();renderAlarms();renderHistory();if(session?.access_token)loadApp().catch(e=>{signOut();$('loginStatus').textContent=e.message});
